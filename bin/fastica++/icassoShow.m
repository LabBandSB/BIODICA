...
fn = sprintf('%s%s_%i_stability.txt',ICAFolder,ICAFileName,ICANumberOfComponents);
save(fn,'Iq','-ASCII');
...
fn = sprintf('%s%s_%i_stability.png',ICAFolder,ICAFileName,ICANumberOfComponents);
print('-dpng',fn,'-r300');
...
title(sprintf('Number of dimensions = %i',ICANumberOfComponents),'FontSize',20);
fn = sprintf('%s%s_%i.png',ICAFolder,ICAFileName,ICANumberOfComponents);
print('-dpng',fn,'-r300');
