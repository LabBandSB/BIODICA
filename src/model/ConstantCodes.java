...
public class ConstantCodes 
{
	...
	public static String NETWORK_DIRECTED_FILE = "NetworkDirectedFile";
	
	public static String COMPUTE_ROBUST_STATISTICS = "ComputeRobustStatistics";
	public static String MIN_NUMBER_OF_DISTINCT_VALUES_IN_NUMERICALS = "MinNumberOfDistinctValuesInNumericals";
	public static String MIN_NUMBER_OF_SAMPLES_IN_CATEGORY = "MinNumberOfSamplesInCategory";
	public static String MAX_NUMBER_OF_CATEGORIES = "MaxNumberOfCategories";
	public static String ASSOCIATION_ANALYSIS_IN_THRESHOLD = "AssociationAnalysisInThreshold";
	public static String SIGNIFICANCE_THRESHOLD_FOR_SHOWING_PLOTS = "SignificanceThresholdForShowingPlots";
	public static String ASSOCIATION_CORRELATION_THRESHOLD = "AssociationCorrelationThreshold";
	...
	public static int FONT_WEIGHT = Font.PLAIN;
